...
//Allgemein
$items_per_page = 15; // angezeigte Elemente pro Seite
$num_of_pages = 10; //angezeigte Seiten in der Pagination
$returnPathVisible = true; // zeigt in der Übersicht die Spalte "ReturnPath" an
?>